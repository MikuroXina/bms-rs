...
pub enum ControlFlowError {
    ...
    /// Invalid integer argument for a control-flow header.
    #[error("invalid integer for {header}: {args}")]
    InvalidIntegerArgument {
        /// The control-flow header name (e.g., RANDOM, IF, CASE).
        header: String,
...
pub struct ParseOutput {
    /// The output Bms.
    pub bms: core::result::Result<Bms, ControlFlowErrorWithRange>,
