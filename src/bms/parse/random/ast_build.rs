...
fn parse_switch_block<'a, I>(iter: &mut std::iter::Peekable<I>) -> (Unit<'a>, Vec<ControlFlowRule>)
where
...
fn parse_random_block<'a, I>(iter: &mut std::iter::Peekable<I>) -> (Unit<'a>, Vec<ControlFlowRule>)
where
    I: Iterator<Item = &'a Token<'a>>,
{
