...
fn test_always_use_older() {
    ...
    assert_eq!(bpm_changes[0].1.bpm, BigDecimal::from(120));
}
...
fn test_always_use_newer() {
    ...
    assert_eq!(bpm_changes[0].1.bpm, BigDecimal::from(160));
}
