...
"#;
    ...
    let atbga_def = &bms.scope_defines.atbga_defs[&ObjId::try_from("01").unwrap()];
    assert_eq!(atbga_def.source_bmp, ObjId::try_from("02").unwrap());
...
"#;
    ...
    let bga_def = &bms.scope_defines.bga_defs[&ObjId::try_from("01").unwrap()];
    assert_eq!(bga_def.source_bmp, ObjId::try_from("02").unwrap());
...
"#;
    ...
    let exrank_def = &bms.scope_defines.exrank_defs[&ObjId::try_from("01").unwrap()];
...
"#;
    ...
    let exwav_def = &bms.scope_defines.exwav_defs[&ObjId::try_from("01").unwrap()];
...
"#;
    ...
    let option = &bms.others.change_options[&ObjId::try_from("01").unwrap()];
...
"#;
    ...
    let text = &bms.others.texts[&ObjId::try_from("01").unwrap()];
